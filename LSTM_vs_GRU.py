...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 29 21:20:40 2022
...
data = pd.read_csv('/Users/juanisaula/Documents/Inflacion_Honduras.csv')

sns.set_style("darkgrid")
plt.figure(figsize=(15,9))
plt.plot(data["Inflacion"])
plt.xticks(range(0,data.shape[0],50),data["Date"].loc[::500], rotation = 45)
plt.title("Stock de Precios ", fontsize = 18, fontweight = "bold")
...
comp_pred['real'] = original[0]
comp_pred['prediccion'] = predict[0]
# ----------------------------------------------------------------------------------
import seaborn as sns
sns.set_style("darkgrid")    
